...
const storyFlow = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "당신은 순간 귀를 의심했다.",
      "“예?”",
      "“혼례 준비 중에는 흔한 일이지. 사람도 많고 드나드는 문건도 많으니 기록 몇 장 없어지는 일이야 생길 수 있네.”",
      "이상했다.",
      "너무 이상했다.",
      "청휘는 그런 사람이 아니었다.",
      "그 누구보다 기록의 중요성을 잘 아는 사헌부 감찰이었다.",
      ...
      "“감찰 나리.”",
      "청휘의 시선이 당신에게 향했다.",
      "“왜 후보 연이의 문건을 빼돌리셨습니까?”",
      "방 안의 공기가 무겁게 가라앉았다.",
      "청휘는 잠시 아무 말도 하지 않았다.",
      "이윽고 입가에 옅은 미소를 띠며 물었다.",
      "“증좌가 있나?”",
      "“청휘 나리는 사건을 지나치게 빨리 종결하려 했습니다.”",
      "“그것만으로는 부족하지.”",
      "맞는 말이었다.",
