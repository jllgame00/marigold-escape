...
const storyFlow = [
  ...
  },
  {
    ...
    title: "이름 없는 소녀의 서찰",
    paragraphs: [
      "혼례를 사흘 앞둔 날이었다. 궁 안팎은 유례없이 분주했다. 곳곳에서는 혼례 준비가 한창이었고, 기록관인 당신 역시 쏟아지는 문건과 보고문에 파묻혀 정신없는 나날을 보내고 있었다.",
      "이현 전하와 유력한 왕비 후보 연이의 혼례는 이미 기정사실로 여겨지고 있었기에, 모두가 다가올 경사를 기대하고 있었다.",
      "그날도 평소와 다름없이 혼례 관련 기록을 정리하던 당신은 책상 위에 놓인 낯선 봉서 하나를 발견했다. 분명 조금 전까지 없었던 것이었다. 봉서에는 보낸 이의 이름도, 관인도 찍혀 있지 않았다. 다만 정갈한 필적으로 짧게 적힌 문구만이 눈에 들어왔다.",

      "「부디 이 글을 읽어주시옵소서.」",

      "이상한 기분에 사로잡힌 당신은 조심스럽게 봉인을 뜯었다. 안에는 서찰 한 장이 들어 있었다. 서찰에는 자신이 억울한 누명을 쓰고 있으며, 혼례를 앞두고 전하와의 추억이 담긴 물건들이 하나둘 사라지거나 훼손되고 있다는 내용이 적혀 있었다. 잠시 서찰을 내려다보던 당신은 함께 동봉된 물건들을 확인했다.",
      "낡은 증좌 그림 여러 장. 그리고 훼손된 물건들의 기록. 깨져버린 도자기. 끊어진 매듭. 사라진 팔찌. 찢겨진 연서. 버려진 초상화. 언뜻 보기에는 서로 아무 관련도 없어 보이는 물건들이었다. 그러나 이상하게도 모든 물건에는 누군가의 소중한 추억이 깃들어 있는 듯했다. 혼례를 앞둔 궁중. 정체를 숨긴 한 소녀의 도움 요청. 그리고 의미를 알 수 없는 증좌들.",
      "당신은 직감했다.",
  ...
  },
  {
    ...
    recordParagraphs: [
      "간택을 앞둔 날 밤, 왕비 후보 연이가 보관하던 향 도자기가 깨진 채 발견되었다.",
      "궁 안에서는 이것이 혼례를 앞둔 불길한 징조라 수군거렸고, 일부는 연이가 스스로 깨뜨렸다고 주장했다.",
    ...
    return (
      <main className="page centerPage clearPage">
        ...
        <section className="truthDocument">
          ...
          <p>
            서찰은 조작되었고, 사라진 기록은 누군가 연이의 동선을 노리고
            있었음을 보여주었다.
          </p>
          <p>
